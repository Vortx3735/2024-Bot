...
public class DriveSubsystem extends SubsystemBase {
    ...
    public static MountPoseConfigs mountPose;
    ...
    public DriveSubsystem() {
       ...
       mountPose = new MountPoseConfigs();
       mountPose.MountPosePitch = MOUNT_PITCH;
       mountPose.MountPoseRoll = MOUNT_ROLL;
       mountPose.MountPoseYaw = MOUNT_YAW;
       pConfig.withMountPose(mountPose);
       pigeon.getConfigurator().apply(pConfig);
       zeroGyroscope();
    ...
    */
    ...
    //     double raw_angle = m_navx.getYaw().getValueAsDouble();
    ...
    public static Rotation2d getGyroscopeRotation() {
        ...
        return Rotation2d.fromDegrees(360.0 + pigeon.getYaw().getValueAsDouble());
    }
    ...
    public void periodic() {
        ...
        //SmartDashboard.putNumber("Angle", m_navx.getYaw().getValueAsDouble());
